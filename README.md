...
cp .env.example .env # add your GROQ_API_KEY (covers both classification and transcription)
...
This project was built primarily using [Jules — or name the actual tool used] as the coding
agent, directed against [`BUILD_BRIEF.md`](./BUILD_BRIEF.md) and its accompanying GitHub
